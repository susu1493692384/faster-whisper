...
class WhisperGUI:
    ...
    def create_control_panel(self, parent):
        ...
        # 模型选择
        tk.Label(model_frame, text="模型:", bg='#f0f0f0', font=self.default_font).pack(anchor=tk.W, padx=10, pady=(12, 5))
        self.model_combo = ttk.Combobox(
            model_frame,
            textvariable=self.model_var,
            values=["base", "large-v3"],
            state="readonly",
            width=25,
            font=self.default_font
        )
        self.model_combo.pack(padx=10, pady=(0, 10))
        ...
        # 第一行按钮
        first_row = tk.Frame(button_frame, bg='#f0f0f0')
        ...
        # 第二行按钮
        second_row = tk.Frame(button_frame, bg='#f0f0f0')
    ...
    def check_available_models(self):
        ...
        if available_models:
            ...
            messagebox.showwarning("警告", "未找到本地模型文件，请先下载模型到 models/ 目录")
    ...
    def transcribe_worker(self):
        ...
        try:
            ...
            update_status(f"正在加载模型: {self.model_var.get()}...")
    ...
    def get_model_path(self):
        ...
        model_path = project_root / "models" / f"whisper-{model_name}-ct2"
